from Code.Utils.utils import CardinalDirection
...
class Discretizer13(Discretizer):
    """Discretizer
    ...
    PREDICATES = {
        ...
        'partner_zone':   [zone.value for zone in CardinalDirection]
    }
    ...
    def get_predicates(self, obs: OvercookedState):
        ...
        # partner_pos = self.get_partner_pos_predicate(obs=obs, player_id=0, partner_id=1)
        partner_zone = self.get_partner_zone_predicate(obs=obs, player_id=0, partner_id=1)
