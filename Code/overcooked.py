...
class OvercookedMultiEnv(SimultaneousEnv):
    ...
    def multi_step(self, ego_action, alt_action):
        ...
        #print(next_state)
        #print(ob_p0, len(ob_p0))
        #print(ob_p1, len(ob_p1))
        #print('---------------------------------------')
        ...
        # We added on Extra Information the following:
        #   - Obs_str: Next state without featurization
        return (ego_obs, alt_obs), (reward, reward), done, {'Obs_str': next_state} # info
